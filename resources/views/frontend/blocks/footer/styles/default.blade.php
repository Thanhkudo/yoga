    ...
    <div class="footer">
        <div class="box-sologen d-flex justify-content-between align-items-center">
            <p class="text text-uppercase">
                {{ $web_information->information->footer ?? '' }}
            </p>
            @isset($web_information->information->link_footer)
                <a href="{{ $web_information->information->link_footer }}"><button
            ...
            <div class="row">
                <div class="col-12 col-lg-4 col-md-6 mb-5">
                    <div class="block block-image">
                        <img width="100" src="{{ $web_information->image->logo_footer ?? '' }}"
                            alt="logo footer" />
                    </div>
                </div>
                @isset($menu)
                    ...
                    <div class="block block-menu">
                        ...
                        <div class="block-content">
                            <ul>
                                ...
                                <li>Hotline: {{ $web_information->information->hotline ?? '' }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="container row justify-content-between align-items-center text-center text-lg-left m-auto p-2">
            ...
            <div class="col-12 col-lg-6 list_icon d-flex justify-content-center justify-content-lg-end">
                ...
                @isset($web_information->social->facebook)
                    <a href="{{ $web_information->social->facebook }}" class="p-2">
                        <img src="{{ url('data/cms-image/icon/ic_bl_facebook.png') }}" alt="Facebook" />
                    </a>
                @endisset
                @isset($web_information->social->tiktok)
                    <a href="{{ $web_information->social->tiktok }}" class="p-2">
                        <img src="{{ url('data/cms-image/icon/ic_bl_tiktok.png') }}" alt="Tiktok" />
                    </a>
                @endisset
                @isset($web_information->social->instagram)
                    <a href="{{ $web_information->social->instagram }}" class="p-2">
                        <img src="{{ url('data/cms-image/icon/ic_bl_instagram.png') }}" alt="Instagram" />
                    </a>
                @endisset
                @isset($web_information->social->youtube)
                    <a href="{{ $web_information->social->youtube }}" class="p-2">
                        <img src="{{ url('data/cms-image/icon/ic_bl_youtube.png') }}" alt="Youtube" />
                    </a>
                @endisset
            </div>
        </div>
