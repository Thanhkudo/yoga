...
<?php $__env->startSection('content'); ?>
    ...
    <section id="page-title" class="page-title-pattern" style="background-image: url(<?php echo e($image_background); ?>);">
                            ...
                            <?php $__currentLoopData = session('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="cart_item" data-id="<?php echo e($id); ?>">
                                    ...
                                    <td class="cart-product-price">
                                        <span class="amount">
                                            <?php echo e(isset($details['price']) && $details['price'] > 0 ? number_format($details['price'],2) : __('Contact')); ?>
                                    ...
                                    <td class="cart-product-quantity">
                                        <div class="quantity">
                                            ...
                                            <input type="text" name="quantity" value="<?php echo e($details['quantity']); ?>"
                                                autocomplete="off" class="qty update-cart" />
                                            <input type="button" value="+" class="plus">
                                        </div>
                                    </td>
                                    <td class="cart-product-subtotal">
                                        <span
                                            class="amount"><?php echo e(number_format($details['price'] * $details['quantity'],2)); ?></span>
                                    </td>
                                </tr>
                                    ...
                                    <div class="row justify-content-between">
                                        <div class="col-lg-12">
                                            <a href="<?php echo e(url()->current()); ?>"
                                                class="button button-3d m-0"><?php echo app('translator')->get('Update Cart'); ?></a>
                                        </div>
                                    </div>
                                </td>
                                <td class="cart-product-subtotal">
                            ...
                            <form class="row" method="POST" action="<?php echo e(route('frontend.order.store.product')); ?>">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" id="affiliate_code" name="affiliate_code"
                                        value="<?php echo e($user_auth->affiliate_code ?? old('affiliate_code')); ?>"
                                        class="sm-form-control" placeholder="<?php echo app('translator')->get('Affiliate code'); ?>" />
                                </div>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\barber\resources\views/frontend/pages/cart/index.blade.php ENDPATH**/ ?>