...
<?php $__env->startSection('content'); ?>
  ...
  <section id="page-title" class="page-title-parallax page-title-dark page-title-center include-header include-topbar"
        style="background: url('<?php echo e($image_background); ?>') no-repeat center center / cover; padding: 110px 0;"
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\raovat\resources\views/frontend/pages/service/detail.blade.php ENDPATH**/ ?>