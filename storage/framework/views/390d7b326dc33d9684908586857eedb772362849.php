                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="json_params[icon]" placeholder="<?php echo app('translator')->get('Icon'); ?>"
                          value="<?php echo e(old('json_params[icon]')); ?>" required>
                      </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\raovat\resources\views/admin/pages/cms_services/create.blade.php ENDPATH**/ ?>