        ...
        <div class="breadcrumb_background">
            <div class="title_full">
                <div class="container a-center">
                    <h1 class="title_page"><?php echo e($title); ?></h1>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="right-content col-lg-8 col-12 order-lg-1">
                    <h1 class="title-page"><?php echo e($title); ?></h1>
                                ...
                                <div class="col-xl-6 col-md-6 col-12">
                                    <div class="item_blog_base">
                                        <a class="thumb" href="<?php echo e($alias); ?>" title="<?php echo e($title); ?>">
                                            <img src="<?php echo e(asset('images/load.gif')); ?>" data-src="<?php echo e($image); ?>"
                                                alt="<?php echo e($title); ?>" class="lazyload img-responsive" />
                                        </a>
                                        <div class="content_blog clearfix">
                                            <h3>
                                                <a href="<?php echo e($alias); ?>" title="<?php echo e($title); ?>"
                                                    class="a-title"><?php echo e($title); ?></a>
                                            </h3>
                                            <div class="time-post">
                                                <span class="author">
                                                ...
                                                <span class="icon posted">
                                                    ...
                                                    Ngày <?php echo e(date('d/m/Y', strtotime($item->created_at))); ?>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\maison\resources\views/frontend/pages/post/category.blade.php ENDPATH**/ ?>