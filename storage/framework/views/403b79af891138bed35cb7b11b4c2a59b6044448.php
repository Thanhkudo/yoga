        ...
        <div class="breadcrumb_background">
            <div class="title_full">
                <div class="container a-center">
                    <h1 class="title_page"><?php echo e($brief); ?></h1>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-12 a-left">
                            <ul class="breadcrumb">
                                ...
                                <li>
                                    <strong><span> <?php echo e($brief); ?></span></strong>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="block-collection col-12">
                        <h1 class="title-page d-none"><?php echo e($brief); ?></h1>
                        <div class="category-products">
                            <div class="col_sortby clearfix">
                                <div class="title_sortby f-left">
                                    <h2 class="collection-title"><?php echo e($brief); ?></h2>
                                </div>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\maison\resources\views/frontend/pages/product/category.blade.php ENDPATH**/ ?>