                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="json_params[brand]"
                                                placeholder="<?php echo app('translator')->get('Brand'); ?>" value="<?php echo e($detail->json_params->brand??""); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\maison\resources\views/admin/pages/cms_products/edit.blade.php ENDPATH**/ ?>