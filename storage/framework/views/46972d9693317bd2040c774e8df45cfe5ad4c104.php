                            ...
                            <div class="grid-inner row g-0">
                                ...
                                <div class="col ps-3">
                                    ...
                                    <div class="entry-meta no-separator">
                                        <ul>
                                            <li class="color">
                                                <?php echo e(isset($item->price) && $item->price > 0 ? number_format($item->price, 0, ',', '.') ." VNĐ" : __('Detail')); ?>
...
<?php /**PATH C:\xampp\htdocs\raovat\resources\views/frontend/components/sidebar/product.blade.php ENDPATH**/ ?>