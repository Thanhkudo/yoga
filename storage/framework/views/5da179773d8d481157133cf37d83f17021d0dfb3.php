                    ...
                    <div class="col-xl-12 col-12">
                        <div class="not-dqtab e-tabs ajax-tab-1 ajax" data-section="ajax-tab-1" data-view="grid_1">
                            ...
                            <div class="tab-container">
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div
                                        class="tab-item tab-item-product tab-content tab-<?php echo e($key); ?> <?php echo e($loop->index == 0 ? 'current' : ''); ?>">
                                                                    ...
                                                                    <div class="product-content">
                                                                        <h3 class="product-name">
                                                                            <a href="<?php echo e($alias); ?>"
                                                                                title="$title"><?php echo e($title); ?></a>
                                                                        </h3>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\yogatest\resources\views/frontend/blocks/cms_product/styles/default.blade.php ENDPATH**/ ?>