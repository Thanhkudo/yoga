                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="json_params[icon]" placeholder="<?php echo app('translator')->get('Icon'); ?>"
                          value="<?php echo e($detail->json_params->icon??""); ?>" required>
                      </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fhmagency/domains/fhmagency.vn/public_html/bds/resources/views/admin/pages/cms_services/edit.blade.php ENDPATH**/ ?>