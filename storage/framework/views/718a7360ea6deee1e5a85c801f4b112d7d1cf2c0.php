                                  ...
                                  <?php if($sub2->parent_id == $sub->id): ?>
                                    <li>
                                      <input name="json_access[menu_id][]" type="checkbox" value="<?php echo e($sub2->id); ?>"
                                        id="json_access_menu_id_<?php echo e($sub2->id); ?>" class="mr-15">
                          ...
                          <?php $__currentLoopData = $activeFunctions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($sub->module_id == $row->id): ?>
                              <li>
                                ...
                                <label for="json_access_function_code_<?php echo e($sub->id); ?>">- -
                                  <?php echo e($sub->name); ?></label>
                              </li>
                            <?php endif; ?>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\raovat\resources\views/admin/pages/roles/create.blade.php ENDPATH**/ ?>