...
<header class="header">
    <?php if(isset($main_menu)): ?>
        <div class="top_header d-none d-xl-block d-lg-block text-center">
            <a href="<?php echo e(route('frontend.home')); ?>" title="Banner header">
                <img class="lazyload" style="height: 110px" src="<?php echo e(asset('images/load.gif')); ?>"
                    data-src="<?php echo e($main_menu->json_params->image ?? $web_information->image->background_breadcrumbs); ?>"
                    alt="Banner header" />
            </a>
        </div>
    <?php endif; ?>
            ...
            <div class="row align-items-center">
                <div class="col-xl-4 col-lg-4 col-12 block-search">
                    <div class="nd-header-search nd-searchs">
                        <form action="<?php echo e(route('frontend.search')); ?>" method="get" class="nd-header-search-form" role="search">
                            <input type="text" name="keyword" class="search-auto form-control"
                                placeholder="Tìm sản phẩm" autocomplete="off" value="<?php echo e(isset($params['keyword']) && $params['keyword'] != ""? $params['keyword'] :""); ?>"/>
                ...
                <div class="col-xl-4 col-lg-3 col-12 d-lg-block d-none block-logo">
                    <a href="<?php echo e(route('frontend.home')); ?>" class="logo">
                        <img width="115px" src="<?php echo e($web_information->image->logo_header ?? ''); ?>" alt="Logo" />
                    </a>
                </div>
                <div class="col-xl-4 col-lg-5 col-12 d-lg-flex header-right">
                    <div class="header-page-link">
                        <ul class="group-account">
                            ...
                            <li class="d-none d-md-block d-lg-block d-xl-block phone_header">
                                <div class="wrap_s">
                                    ...
                                    <div class="content_s">
                                        ...
                                        <a class="fone" href="tel:<?php echo e($web_information->information->phone ?? ''); ?>"
                            ...
                            <li class="cart-drop">
                                <div class="icon">
                                    <a href="#" class="nd-header-cart" aria-label="Xem giỏ hàng" title="Giỏ hàng">
                                        ...
                                        <span class="count_item_pr"><?php echo e(count((array) session('cart') ?? 0)); ?></span>
                                    </a>
                                </div>
                            </li>
                        </ul>
                                    ...
                                    <?php if(isset($main_menu)): ?>
                                        <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($item->parent_id == $main_menu->id): ?>
                                                <?php if($item->sub <= 0): ?>
                                                    <li
                                                        class="nav-item <?php echo e($item->url_link == url()->full() ? 'active' : ''); ?>">
                                                        <a class="a-img" href="<?php echo e($item->url_link); ?>"
                                                ...
                                                <?php else: ?>
                                                    <li
                                                        ...
                                                        <i
                                                            class="fa fa-caret-down d-block d-sm-block d-lg-none d-xl-none"></i>
                                                        <ul class="item_small">
                                                            <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php if($item_sub->parent_id == $item->id): ?>
                                                                    <?php if($item_sub->sub <= 0): ?>
                                                                        <li class="">
                                                                            <a class=""
                                                                                href="<?php echo e($item_sub->url_link); ?>"
...
<?php /**PATH C:\xampp\htdocs\yogatest\resources\views/frontend/blocks/header/styles/default.blade.php ENDPATH**/ ?>