                    ...
                    <div class="swiper_service swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="content-service">
                                    <div class="service-right">
                                        <div class="title-service">Hỗ trợ 24/7</div>
                                    ...
                                    <div class="service-left">
                                        <img class="lazyload"
                                            ...
                                            data-src="//bizweb.dktcdn.net/100/448/970/themes/894899/assets/service_1.svg?1676280280637"
                                            alt="Hỗ trợ 24/7" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="content-service">
                                    <div class="service-right">
                                        <div class="title-service">Thanh toán</div>
                                        <div class="service-sumary">Bảo mật thanh toán</div>
                                    </div>
                                    <div class="service-left">
                                        <img class="lazyload"
                                            src="data:image/png;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA="
                                            data-src="//bizweb.dktcdn.net/100/448/970/themes/894899/assets/service_2.svg?1676280280637"
                                            alt="Thanh toán" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="content-service">
                                    <div class="service-right">
                                        <div class="title-service">Giao hàng</div>
                                        <div class="service-sumary">Giao hàng tận nhà</div>
                                    </div>
                                    <div class="service-left">
                                        <img class="lazyload"
                                            src="data:image/png;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA="
                                            data-src="//bizweb.dktcdn.net/100/448/970/themes/894899/assets/service_3.svg?1676280280637"
                                            alt="Giao hàng" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="widget-ft">
                            <div class="blocklogo">
                                <a href="index.html" class="logofooter">
                                    <img width="270" height="75"
                                        src="<?php echo e($web_information->image->logo_footer ?? ''); ?>" alt="Logo footer" />
                                </a>
                            </div>
                            ...
                            <div class="contactfooter">
                                <div class="flop mt">
                                    <div class="section clearfix">
                                        ...
                                        <div class="fright">
                                            <span><?php echo $web_information->information->address ?? ''; ?></span>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-8 col-lg-8 col-12">
                        <div class="row">
                            <?php if(isset($menu)): ?>
                                <?php
                                    ...
                                    foreach ($footer_menu as $main_menu) {
                                        ...
                                        $content .= '<div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6"><div class="widget-ft link-list">';
                                        $content .= '<h4 class="title-menu">' . $title . '</h4>';
                                        $content .= '<div class="row content-menu">';
                                        $content .= '<div class="col-xl-6 col-lg-6 col-12">';
                                        ...
                                        foreach ($menu as $item) {
                                            if ($item->parent_id == $main_menu->id) {
                                                ...
                                                $url = $item->url_link;
                                                $content .= '<li class="li_menu"><a href="' . $url . '">' . $title . '</a>';
                                                $content .= '</li>';
                                                $i++;
                                                if ($i % 3 == 0) {
                                                $content .= '</ul></div>';
                            ...
                            <div class="col-xl-6 col-lg-6 col-12 mail_footer">
                                <div class="mail_img">
                                    <img class="lazyload" width="64px" src="<?php echo e(asset('images/load.gif')); ?>"
                                        data-src="<?php echo e(asset('images/ic-mail.png')); ?>" alt="Template Big Green" />
                                </div>
                                ...
                                <div class="form-footer">
                                    <div class="form-wrapper columns_margin_bottom_20 columns_padding_15">
                                        <div class="mail_footer subscribe">
                                            <form id="mc-form" action="<?php echo e(route('frontend.contact.store')); ?>" class="form_ajax newsletter-form"
                                                ...
                                                <div class="input-group">
                                                    <div class="groupiput">
                                                        ...
                                                        <span class="input-group-append subscribe">
                                                            <button class="btn btn-primary btn-lienhe" type="submit"
...
<?php /**PATH C:\xampp\htdocs\yogatest\resources\views/frontend/blocks/footer/styles/default.blade.php ENDPATH**/ ?>