    ...
    <section id="slider" class="slider-element include-header include-topbar"
        ...
        <div class="container" style="z-index: 2">
            <div class="tabs advanced-real-estate-tabs">
                ...
                <span class="more-search"><i class="icon-line-plus"></i> Tìm kiếm nâng cao</span>
            </div>
        </div>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\raovat\resources\views/frontend/pages/product/category.blade.php ENDPATH**/ ?>