                    ...
                    <td>
                      <?php if(isset($routes['show_route'][$row->route_name]) && $routes['show_route'][$row->route_name]): ?>
                        <?php if($routes['has_alias'][$row->route_name]): ?>
                          <a href="<?php echo e(route($row->route_name)); ?>" target="_blank"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\yogatest\resources\views/admin/pages/pages/index.blade.php ENDPATH**/ ?>