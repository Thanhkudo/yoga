                    ...
                    <form action="/cart" method="post" novalidate="" class="cart ajaxcart">
                            ...
                            <?php $__currentLoopData = session('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="ajaxcart__row">
                                    <div class="ajaxcart__product cart_product" data-line="1">
                                        <a href="<?php echo e($alias); ?>" class="ajaxcart__product-image cart_image" title="<?php echo e($details['title']); ?>"><img width="80" height="80" src="<?php echo e($details['image_thumb'] ?? $details['image']); ?>" alt="<?php echo e($details['title']); ?>"></a>
                                        <div class="grid__item cart_info">
                                            <div class="ajaxcart__product-name-wrapper cart_name">
                                                <a href="<?php echo e($alias); ?>" class="ajaxcart__product-name h4" title="<?php echo e($details['title']); ?>"><?php echo e($details['title']); ?></a>
                                            </div>
                                            <div class="grid">
                                                ...
                                                <div class="grid__item one-half text-right cart_prices">
                                                    <span class="cart-price"><?php echo e(isset($details['price']) && $details['price'] > 0 ? number_format($details['price'], '0',',','.') :"0"); ?>₫</span>
                                                    <a class="cart__btn-remove remove-from-cart ajaxifyCart--remove" href="javascript:;" data-id="<?php echo e($id); ?>">Xóa</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="ajaxcart__footer ajaxcart__footer--fixed cart-footer">
                            ...
                            <div class="cart__btn-proceed-checkout-dt">
                                <button onclick="location.href='<?php echo e(route('frontend.order.cart')); ?>'" type="button" class="button btn btn-default cart__btn-proceed-checkout" id="btn-proceed-checkout" title="Thanh toán">Đặt hàng</button>
                            </div>
                        </div>
                    </form>
                <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\yogatest\resources\views/frontend/layouts/default.blade.php ENDPATH**/ ?>