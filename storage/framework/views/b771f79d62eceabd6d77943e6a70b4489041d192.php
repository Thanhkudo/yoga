...
<?php $__env->startSection('content'); ?>
  ...
  <section id="page-title" class="page-title-parallax page-title-dark page-title-center include-header include-topbar"
        style="background: url('<?php echo e($image); ?>') no-repeat center center / cover; padding: 130px 0;"
        data-center="background-position: 0px -130px;" data-top-bottom="background-position:0px 100px;">
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\raovat\resources\views/frontend/pages/post/detail.blade.php ENDPATH**/ ?>