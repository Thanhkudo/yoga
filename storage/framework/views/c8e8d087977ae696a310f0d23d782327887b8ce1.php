<script src="<?php echo e(asset('themes/frontend/maison/js/jquery.js')); ?>"></script>
<script src="<?php echo e(asset('themes/frontend/maison/js/plugins.min.js')); ?>"></script>
<script src="<?php echo e(asset('themes/frontend/maison/js/main.js')); ?>"></script>
<script src="<?php echo e(asset('themes/frontend/maison/js/swiper.js')); ?>"></script>
<script src="<?php echo e(asset('themes/frontend/maison/js/lazysizes.min.js')); ?>"></script>
<script src="<?php echo e(asset('themes/frontend/maison/js/functions.js')); ?>"></script>
        ...
        $(".btn-buy-now").click(function(e) {
            ...
            if (_id > 0 && _quantity > 0) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        window.location.href = '<?php echo e(route('frontend.order.cart')); ?>';
                    },
                    error: function(data) {
                        // Get errors
                        var errors = data.responseJSON.message;
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\yogatest\resources\views/frontend/panels/scripts.blade.php ENDPATH**/ ?>