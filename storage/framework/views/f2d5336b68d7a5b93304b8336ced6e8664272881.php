        ...
        <div class="container">
            <div class="row">
                <div class="block-collection col-12">
                    <h1 class="title-page d-none">Tất cả sản phẩm</h1>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\maison\resources\views/frontend/pages/all/index.blade.php ENDPATH**/ ?>