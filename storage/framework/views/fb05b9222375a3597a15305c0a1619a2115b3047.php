                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-md-6">
                                            <div class="form-group">
                                              ...
                                              <div class="input-group">
                                                <span class="input-group-btn">
                                                  <a data-input="image_background-<?php echo e($item->id); ?>" data-preview="image_background-holder-<?php echo e($item->id); ?>" data-type="cms-image"
                                                    class="btn btn-primary lfm">
                                                    <i class="fa fa-picture-o"></i> <?php echo app('translator')->get('Select'); ?>
                                                  </a>
                                                </span>
                                                <input id="image_background-<?php echo e($item->id); ?>" class="form-control" type="text" name="image_background"
                                                  placeholder="<?php echo app('translator')->get('Image source'); ?>" value="<?php echo e($item->image_background); ?>">
                                              </div>
                                              <div id="image_background-holder-<?php echo e($item->id); ?>" style="margin-top:15px;max-height:100px;">
                                                    ...
                                                    <div class="row">
                                                      ...
                                                      <div class="col-md-6">
                                                        <div class="form-group">
                                                          ...
                                                          <div class="input-group">
                                                            <span class="input-group-btn">
                                                              <a data-input="image-<?php echo e($item_sub_1->id); ?>" data-preview="image-holder-<?php echo e($item_sub_1->id); ?>" class="btn btn-primary lfm"
                                                                data-type="cms-image">
                                                                <i class="fa fa-picture-o"></i> <?php echo app('translator')->get('Select'); ?>
                                                              </a>
                                                            </span>
                                                            <input id="image-<?php echo e($item_sub_1->id); ?>" class="form-control" type="text" name="image"
                                                              placeholder="<?php echo app('translator')->get('Image source'); ?>" value="<?php echo e($item_sub_1->image); ?>">
                                                          </div>
                                                          <div id="image-holder-<?php echo e($item_sub_1->id); ?>" style="margin-top:15px;max-height:100px;">
                                                      ...
                                                      <div class="col-md-6">
                                                        <div class="form-group">
                                                          ...
                                                          <div class="input-group">
                                                            <span class="input-group-btn">
                                                              <a data-input="image_background-<?php echo e($item_sub_1->id); ?>" data-preview="image_background-holder-<?php echo e($item_sub_1->id); ?>" data-type="cms-image"
                                                                class="btn btn-primary lfm">
                                                                <i class="fa fa-picture-o"></i> <?php echo app('translator')->get('Select'); ?>
                                                              </a>
                                                            </span>
                                                            <input id="image_background-<?php echo e($item_sub_1->id); ?>" class="form-control" type="text" name="image_background"
                                                              placeholder="<?php echo app('translator')->get('Image source'); ?>" value="<?php echo e($item_sub_1->image_background); ?>">
                                                          </div>
                                                          <div id="image_background-holder-<?php echo e($item_sub_1->id); ?>" style="margin-top:15px;max-height:100px;">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\maison\resources\views/admin/pages/block_contents/edit.blade.php ENDPATH**/ ?>