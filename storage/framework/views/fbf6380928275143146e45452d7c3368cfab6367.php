        ...
        <div class="breadcrumb_background">
            <div class="title_full">
                <div class="container a-center">
                    <h1 class="title_page"><?php echo e($page_title); ?></h1>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-12 a-left">
                            <ul class="breadcrumb">
                                ...
                                <li>
                                    <strong><span><?php echo e($page_title); ?></span></strong>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-sm-12 col-12">
                        <div class="single-contact a-center">
                            ...
                            <div class="title-contact">Địa chỉ</div>
                            <span>
                    ...
                    <div class="col-xl-4 col-lg-4 col-sm-12 col-12">
                        <div class="single-contact a-center">
                            ...
                            <div class="title-contact">Tổng đài hỗ trợ</div>
                            <a href="mailto:hellocafein@gmail.com"
                                title="hellocafein@gmail.com"><?php echo e($web_information->information->hotline); ?></a>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-sm-12 col-12">
                        <div class="single-contact a-center">
                            ...
                            <a class="fone" href="tel:19006750"
                                title="19006750"><?php echo e($web_information->information->email); ?></a>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="left_contact">
                                        <h1 class="title-head-contact a-center">
                                        ...
                                        <div id="pagelogin">
                                            <form class="form_ajax" action="<?php echo e(route('frontend.contact.store')); ?>"
                                                method="post" id="contact" accept-charset="UTF-8">
                                                <?php echo csrf_field(); ?>
                                                ...
                                                <div class="form-signup clearfix">
                                                    <div class="row group_contact">
                                                        <fieldset
                                                            class="form-group col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                                            <input type="text" id="name" name="name"
                                                                value="" class="form-control  form-control-lg required" required
                                                ...
                                                class="form-control form-control-lg" required placeholder="Email:"/>
                                                        ...
                                                        <fieldset
                                                            ...
                                                            <textarea class="form-control content-area form-control-lg" id="content" name="content" rows="6" cols="30" required></textarea>
                                                        </fieldset>
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <button type="submit" class="btn btn-primary btn-lienhe">
                                                                Gửi liên hệ
                                                            </button>
                                                        </div>
                                                    </div>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\maison\resources\views/frontend/pages/contact/index.blade.php ENDPATH**/ ?>