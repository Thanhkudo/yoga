    ...
    <div class="breadcrumb_background">
        <div class="title_full">
            <div class="container a-center">
                <p class="title_page"><?php echo e($title); ?></p>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-12 a-left">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a class="changeurl" href="<?php echo e($alias_category); ?>"><span><?php echo e($taxonomy_title); ?></span></a>
                                <span class="mr_lr"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                        <!--! Font Awesome Pro 6.0.0 by @fontawesome  - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                        <path
                                            d="M96 480c-8.188 0-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L242.8 256L73.38 86.63c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l192 192c12.5 12.5 12.5 32.75 0 45.25l-192 192C112.4 476.9 104.2 480 96 480z" />
                            ...
                            <li>
                                <strong><span><?php echo e($title); ?></span></strong>
                            </li>
                            <li></li>
                        </ul>
                    </div>
                            ...
                            <div class="product-image-block relative clearfix">
                                <div class="swiper-container gallery-top col_large_default large-image">
                                    <div class="swiper-wrapper" id="lightgallery" data-lightbox="gallery">
                                        <a class="swiper-slide grid-item" href="<?php echo e($image_product_screen); ?>" data-lightbox="gallery-item"
                                            title="Click để xem">
                                            <img height="540" width="540" src="<?php echo e($image_product_screen); ?>"
                                                alt="<?php echo e($title); ?>" data-image="<?php echo e($image_product_screen); ?>"
                                                class="img-product img-responsive mx-auto d-block swiper-lazy" />
                                        </a>
                                        <?php if(isset($detail->json_params->gallery_image)): ?>
                                            <?php $__currentLoopData = $detail->json_params->gallery_image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a class="swiper-slide grid-item" href="<?php echo e($value); ?>" data-lightbox="gallery-item"
                                                    title="Click để xem">
                                                    <img height="540" width="540" src="<?php echo e($value); ?>"
                                                        alt="<?php echo e($title); ?>" data-image="<?php echo e($value); ?>"
                                                        class="img-product img-responsive mx-auto d-block swiper-lazy" />
                                                </a>
                                    ...
                                    <div class="swiper-container gallery-thumbs">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="p-100">
                                                    <img height="80" width="80" src="<?php echo e($image_product_screen); ?>"
                                                        alt="<?php echo e($title); ?>" data-image="<?php echo e($image_product_screen); ?>"
                                                        class="swiper-lazy" />
                                                </div>
                                            </div>
                        ...
                        <div class="details-pro col-12 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <div class="inventory_quantity">
                                <span class="mb-break">
                                    ...
                                    <span class="a-vendor"> <?php echo e($detail->json_params->brand ?? 'Đang cập nhật'); ?> </span>
                                </span>
                                <span class="line">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
                                <span class="mb-break">
                                    <span class="stock-brand-title">Tình trạng:</span>
                                    <span class="a-stock"> <?php echo e($detail->status == 'active' ? 'Còn hàng' : 'Hết hàng'); ?>
                                ...
                                <div class="price-box clearfix">
                                    <span class="special-price">
                                        <span
                                            class="price product-price"><?php echo e($price ? number_format($price, 0, ',', '.') : '0'); ?>₫</span>
                                    </span>
                                    ...
                                    <div class="clearfix form-group">
                                        <div class="flex-quantity">
                                            <div class="btn-mua button_actions clearfix">
                                                <button type="button" class="btn fast btn_base btn-buy-now btn-cart" data-id="<?php echo e($detail->id); ?>">
                                                    <span class="txt-main text_1">Mua ngay</span>
                                                    <span class="regular">Giao hàng tận nay quý khách</span>
                                                </button>
                                                <button type="submit"
                                                    class="btn btn_base normal_button btn_add_cart add_to_cart btn-cart" data-id="<?php echo e($detail->id); ?>">
                                                            ...
                                                            <div class="wishItem variants product-box product-block-item">
                                                                ...
                                                                <div class="product-info">
                                                                    <div class="product-content">
                                                                        ...
                                                                        <div class="blockprice">
                                                                            <div class="price-box">
                                                                                <?php echo e($price ? number_format($price, 0, ',', '.') : '0'); ?>₫
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="product-action d-xl-flex d-none">
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        data-id="<?php echo e($item->id); ?>" data-quantity="1" title="Mua hàng">
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\maison\resources\views/frontend/pages/product/detail.blade.php ENDPATH**/ ?>