    ...
    <div class="breadcrumb_background">
        ...
        <div class="title_full">
            <div class="container a-center">
                <h1 class="title_page"> <?php echo e(isset($params['keyword']) && $params['keyword'] != ""? $params['keyword'] ." - ":""); ?>Tìm kiếm</h1>
            </div>
        </div>
    </div>
    <section class="signup search-main wrap_background background_white clearfix">
        <div class="container">
            <div class="margin-bottom-15 no-padding">
                <h1 class="title-head title_search text-center">Có <?php echo e(count($posts)); ?> kết quả tìm kiếm phù hợp</h1>
            </div>
                                    ...
                                    <div class="wishItem variants product-box product-block-item">
                                        <div class="product-thumbnail">
                                            <a class="image_thumb scale_hover product-transition"
                                                href="<?php echo e($alias); ?>" title="<?php echo e($title); ?>">
                                                <img class="lazyload"
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\maison\resources\views/frontend/pages/search/index.blade.php ENDPATH**/ ?>